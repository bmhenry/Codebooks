...
####Runtime
You'll need PyQt5 installed and located in your Python path. Make sure it's 32-bit if your Python installation is 32-bit, and 64-bit otherwise.
To run the program, double-click codebooks.pyw or run it from the command line with 'pythonw codebooks.pyw' .
